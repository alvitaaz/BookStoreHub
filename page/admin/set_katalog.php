<?php
include "../../db.php";
// Hapus pemanggilan session_start() di sini
// session_start();
...
<div class="container">
    ...
    <table id="mytable" class="table table-bordered" style="width:75%;">
        <thead>
            ...
            <th><center>Nama Katalog</center></th>
          ...
          <form action="tambah_katalog.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                <div class="form-group">
                    ...
                    <select class="form-control" name="kategori">
                        <?php
                            // Menggunakan MySQLi
                            $q_allkat = mysqli_query($koneksi, "SELECT * from kategori"); 
                            while($kat1 = mysqli_fetch_array($q_allkat)){
                        ?>
                ...
                <div class="form-group" style="padding-bottom: 20px;">
                  <label for="Modal Name">Katalog baru</label>
                  <input type="text" name="katalog"  class="form-control" placeholder="Katalog baru" required/>
                </div>
