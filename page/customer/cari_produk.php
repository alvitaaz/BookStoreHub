<center>
    ...
    <a href="#"><?php echo $pencarian['judul']; ?></a><br> 
    Rp.<?php echo number_format($pencarian['harga']); ?>,-<br>

    <?php 
    // Ganti mysql_fetch_array dengan mysqli_fetch_array
    $qrystok = mysqli_query($conn, "SELECT * FROM stok WHERE id_buku='$pencarian[id_buku]'");
    while($stok = mysqli_fetch_array($qrystok)){
    ?>
    <br>
    <div style="text-align:center;">stok tersedia <b><?php echo $stok['stok']; ?></b></div>
    <?php if($stok['stok'] >= 1){ ?>
