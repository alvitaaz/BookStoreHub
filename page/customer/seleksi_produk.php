...
<a href="#"><?php echo $seleksi_buku['judul']; ?></a><br> Rp.<?php echo number_format($seleksi_buku['harga']); ?>,-<br>
<?php 
$qrystok = mysqli_query($conn, "SELECT * FROM stok where id_buku='$seleksi_buku[id_buku]'");
